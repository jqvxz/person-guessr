...
async function fetchTopImages() {
    ...
    try {
        const response = await fetch(
            `https://www.googleapis.com/customsearch/v1?q=portrait+of+a+person+from+${encodeURIComponent(country)}&cx=${GOOGLE_CX}&key=${GOOGLE_API_KEY}&searchType=image&num=10`
        );
